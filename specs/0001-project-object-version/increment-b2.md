...
Osobno przyjęty [B2a4a — komunikaty OAuth](increment-b2a4a.md) obejmuje wyłącznie
form/basic encoding i parser niezaufanych tokenów. Transport POST z polityką
logowania (B2a4b) oraz orchestration wymagają kolejnych spec/review.
Pozostałe decyzje i fasada
